...
static const char *poweroff[] = { "dwm_run", "shutdown", "-m", dmenumon, "-fn", dmenufont, "-nb", col_gray1, "-nf", col_gray3, "-sb", col_gray1, "-sf", col_gray4, NULL };
static const char *reboot[]   = { "dwm_run", "reboot", "-m", dmenumon, "-fn", dmenufont, "-nb", col_gray1, "-nf", col_gray3, "-sb", col_gray1, "-sf", col_gray4, NULL };
static const char *termcmd[]  = { "dwm_run", "term", NULL };
static const char *www[]      = { "dwm_run", "browser", NULL };
static const char *fm[]       = { "dwm_run", "filemanager", NULL };
static const char *rootfm[]   = { "sudo", "dwm_run", "filemanager", "/", NULL };
...
static Key keys[] = {
	...
	{ SUPER,                        XK_r,      spawn,          {.v = reboot } },
	{ SUPER,                        XK_p,      spawn,          {.v = poweroff } },
